...
from administracion.models import Estado , Turno
...
def sumarInasistencia(request, pk):
    # Obtener el registro de Asistencias correspondiente al ID
    asistencia = get_object_or_404(Asistencias, pk=pk)
    
    # Incrementar el contador de inasistencias
    asistencia.inasistencias += 1  
    
    # Guardar los cambios en la base de datos
    asistencia.save()
    messages.success(request,'Se agrego la inasistencia correctamente.')
    
    return redirect('inasistencia')  
