...
from inscripciones.models import Curso 
from administracion.models import Turno
from docentes.models import Calificaciones , Asistencias
from inscripciones.forms import FormAlumno
